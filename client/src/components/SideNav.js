              ...
              <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                  {collapsed ? (
                      <div style={{ textAlign: "center" }}>
                          ...
                          <hr style={{ width: "100%", height: "4px", backgroundColor: "#fff", marginTop: "4px", marginBottom: "14px" }} />
                      </div>
                  ) : (
                  ...
                  <div style={{ flex: "1", userSelect: "none" }}>
                      <Menu>
                          ...
                          >
                              Dashboard
                              {location.pathname === "/main" && <div style={rectangleStyle}></div>}
                          </MenuItem>
                          <MenuItem
                              onClick={() => setCollapsed((prev) => !prev)}
                              icon={
                          ...
                          >
                              TBAs
                              {location.pathname === "/tbalist" && <div style={rectangleStyle}></div>}
                          </MenuItem>
                          <MenuItem
                              onClick={() => setCollapsed((prev) => !prev)}
                              icon={
                          ...
                          >
                              Contracts
                              {location.pathname === "/contract" && <div style={rectangleStyle}></div>}
                          </MenuItem>
                          <MenuItem
                              onClick={() => setCollapsed((prev) => !prev)}
                              icon={
                          ...
                          >
                              Airdrop
                              {location.pathname === "/airdrop" && <div style={rectangleStyle}></div>}
                          </MenuItem>
                          <MenuItem
                              onClick={() => setCollapsed((prev) => !prev)}
                              icon={
                          ...
                          >
                              Manager
                              {location.pathname === "/manager" && <div style={rectangleStyle}></div>}
                          </MenuItem>
                      </Menu>
                  </div>
