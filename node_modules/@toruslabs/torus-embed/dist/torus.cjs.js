...
;// CONCATENATED MODULE: ./src/ObservableStore.ts
...
class ObservableStore extends openlogin_jrpc_namespaceObject.SafeEventEmitter {
  ...
  updateState(partialState) {
    ...
    if (partialState && typeof partialState === "object") {
      ...
      this.putState(_objectSpread(_objectSpread({}, state), partialState));
...
;// CONCATENATED MODULE: external "readable-stream"
const external_readable_stream_namespaceObject = require("readable-stream");
;// CONCATENATED MODULE: ./src/ObservableStoreStream.ts


class ObservableStoreStream extends external_readable_stream_namespaceObject.Duplex {
  constructor(obsStore) {
    ...
    defineProperty_default()(this, "handler", void 0);
    defineProperty_default()(this, "obsStore", void 0);
    this.resume();
  ...
  return (req, res, next) => {
    ...
    if (typeof req.method !== "string" || !req.method) {
      res.error = rpc_errors_namespaceObject.rpcErrors.invalidRequest({
        ...
        data: utils_objectSpread(utils_objectSpread({}, req || {}), {}, {
...
function inpage_provider_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function inpage_provider_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? inpage_provider_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : inpage_provider_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
class TorusInpageProvider extends openlogin_jrpc_namespaceObject.SafeEventEmitter {
  constructor(connectionStream) {
    ...
    // private state
    this._state = inpage_provider_objectSpread({}, TorusInpageProvider._defaultState);
    ...
    external_pump_default()(mux.createStream("publicConfig"), storeAsStream(this._publicConfigStore),
  ...
  async request(args) {
    if (!args || typeof args !== "object" || Array.isArray(args)) {
      throw rpc_errors_namespaceObject.rpcErrors.invalidRequest({
        ...
        data: inpage_provider_objectSpread(inpage_provider_objectSpread({}, args || {}), {}, {
