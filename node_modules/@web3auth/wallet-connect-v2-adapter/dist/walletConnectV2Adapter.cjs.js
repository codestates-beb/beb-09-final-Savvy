...
var query_string = __webpack_require__(3041);
...
class WalletConnectV2Adapter extends base_evm_adapter_namespaceObject.BaseEvmAdapter {
  ...
  async init(options) {
    ...
    this.connector = await dist_index_es_M.init(adapterSettings === null || adapterSettings === void 0 ? void 0 : adapterSettings.walletConnectInitOptions);
  ...
  cleanupPendingPairings() {
    ...
    if (!index_es_C(inactivePairings)) return;
    inactivePairings.forEach(pairing => {
      if (this.connector) {
        this.connector.pairing.delete(pairing.topic, w("USER_DISCONNECTED"));
      }
    });
  }
