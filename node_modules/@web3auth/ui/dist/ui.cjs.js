...
__webpack_require__.d(__webpack_exports__, {
  ...
  PASSWORDLESS_BACKEND: () => (/* reexport */ PASSWORDLESS_BACKEND),
  ...
  getPasswordlessBackendUrl: () => (/* reexport */ getPasswordlessBackendUrl),
...
function ExternalWallet(props) {
  ...
  const [t] = (0,external_react_i18next_namespaceObject.useTranslation)();
  (0,react.useEffect)(() => {
    var _config$WALLET_ADAPTE, _config$walletConnect;
    base_namespaceObject.log.debug("loaded external wallets", config, walletConnectUri, deviceType);
    const walletConnectAdapterName = (_config$WALLET_ADAPTE = config[base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V1]) !== null && _config$WALLET_ADAPTE !== void 0 && _config$WALLET_ADAPTE.showOnModal ? base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V1 : base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V2;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [showBackButton && /*#__PURE__*/(0,jsx_runtime.jsxs)("button", {
        ...
        if (walletConnectUri && deviceDetails.platform === (external_bowser_default()).PLATFORMS_MAP.desktop && [base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V1, base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V2].includes(adapter)) {
...
const getPasswordlessBackendUrl = web3AuthNetwork => {
  var _PASSWORDLESS_BACKEND;
  return (_PASSWORDLESS_BACKEND = PASSWORDLESS_BACKEND[web3AuthNetwork]) !== null && _PASSWORDLESS_BACKEND !== void 0 ? _PASSWORDLESS_BACKEND : PASSWORDLESS_BACKEND.mainnet;
};
const getUserCountry = async web3AuthNetwork => {
  try {
    const result = await (0,http_helpers_namespaceObject.get)(`${getPasswordlessBackendUrl(web3AuthNetwork)}/api/v2/user/location`);
...
const validatePhoneNumber = async (phoneNumber, web3AuthNetwork) => {
  try {
    const result = await (0,http_helpers_namespaceObject.post)(`${getPasswordlessBackendUrl(web3AuthNetwork)}/api/v2/phone_number/validate`, {
...
function Modal(props) {
  ...
  (0,react.useEffect)(() => {
    ...
    if (modalState.modalVisibility) {
      setModalState(prevState => {
        return Modal_objectSpread(Modal_objectSpread({}, prevState), {}, {
...
class LoginModal extends openlogin_jrpc_namespaceObject.SafeEventEmitter {
  constructor(_ref) {
    ...
    defineProperty_default()(this, "handleAdapterData", adapterData => {
      ...
      } else if (adapterData.adapterName === base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V2) {
        const walletConnectData = adapterData.data;
        this.updateWalletConnect(walletConnectData.uri, walletConnectData.extensionAdapters);
      }
    });
